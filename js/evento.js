// js/evento.js
import { db } from './firebase-init.js'; // Solo necesitamos 'db' aquí
    ...
    async function loadEventDetails() {
        ...
        try {
            ...
            if (eventDocSnap.exists()) {
                ...
                buyTicketsBtn = document.getElementById('buyTicketsBtn'); // Obtener referencia después de la inyección
                if (buyTicketsBtn) {
                    buyTicketsBtn.addEventListener('click', () => {
                        // Guardar datos del evento en sessionStorage para la página de pago
                        ...
                        console.log("evento.js: Redirigiendo a pago.html con ID:", currentEventData.id);
                        window.location.href = `pago.html?id=${currentEventData.id}`; // Redirigir a la página de selección de asientos
                    });
                }
